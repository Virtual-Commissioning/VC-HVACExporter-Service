...
namespace HVACExporter.Models.Zone
{
    public class SubSurfWindow
    {
        ...
        public SubSurfWindow(string id, string tag, string subSurfType, string constructionId, string hostSurfId, string outsideBCObj, string viewFactorToGround, FrameAndDivider frameAndDivider, int multiplier, VertexCoordinates vertexCoordinates)
        {
            Id = id;
            Tag = tag;
