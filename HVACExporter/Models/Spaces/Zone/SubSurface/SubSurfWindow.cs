...
namespace HVACExporter.Models.SubSurfWindow
{
    public class SubSurfWindow
    {
        ...
        public SubSurfWindow(string id, string tag, SubSurfType subSurfType, string constructionId, string hostSurfId, OutsideBCObj outsideBCObj, string viewFactorToGround, FrameAndDivider frameAndDivider, int multiplier, VertexCoordinates vertexCoordinates)
        {
            Id = id;
            Tag = tag;
