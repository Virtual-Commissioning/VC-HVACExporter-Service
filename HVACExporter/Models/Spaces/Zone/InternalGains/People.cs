...
namespace HVACExporter.Models.Zone
{
    public class People
    {
        ...
        public People(string id, string zoneName, string peopleSchedule, string calculationMethod, int numberOfPeople, 
            ...
            string mRTCalculationType, string surfaceId, string workEfficiencySchedule, string clothingInsulationCalculationMethod, 
            string clothingInsulationSchedule, string airVelocitySchedule, string thermalComfortType)
        {
            Name = id;
